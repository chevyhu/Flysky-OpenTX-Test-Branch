...
#define TR_VTRAINERMODES                                                    \
  TR_VTRAINER_MASTER_JACK TR_VTRAINER_SLAVE_JACK TR_VTRAINER_MASTER_BATTERY \
      TR_VTRAINER_BLUETOOTH
#elif defined(PCBX9E)
#define TR_VTRAINERMODES                                            \
  TR_VTRAINER_MASTER_JACK TR_VTRAINER_SLAVE_JACK                    \
      TR_VTRAINER_MASTER_SBUS_MODULE TR_VTRAINER_MASTER_CPPM_MODULE \
          TR_VTRAINER_MASTER_BATTERY TR_VTRAINER_BLUETOOTH
...
#define TR_VTEMPLATES                                                        \
  TR_TEMPLATE_CLEAR_MIXES TR_TEMPLATE_SIMPLE_4CH TR_TEMPLATE_STICKY_TCUT     \
      TR_TEMPLATE_VTAIL TR_TEMPLATE_DELTA TR_TEMPLATE_ECCPM TR_TEMPLATE_HELI \
...
#define OFS_R9M_LBT_POWER_VALUES \
  (OFS_R9M_FCC_POWER_VALUES + sizeof(TR_R9M_FCC_POWER_VALUES))
#define OFS_TELEMETRY_PROTOCOLS \
  (OFS_R9M_LBT_POWER_VALUES + sizeof(TR_R9M_LBT_POWER_VALUES))
#define OFS_XJT_PROTOCOLS \
  (OFS_TELEMETRY_PROTOCOLS + sizeof(TR_TELEMETRY_PROTOCOLS))
...
#define OFS_MAVLINK_AP_MODES \
  (OFS_MAVLINK_AC_MODES + sizeof(TR_MAVLINK_AC_MODES))
...
#if defined(PCBSKY9X)
#define LEN_CALIB_FIELDS                                                 \
  (PSIZE(TR_BATT_CALIB) > PSIZE(TR_CURRENT_CALIB) ? PSIZE(TR_BATT_CALIB) \
                                                  : PSIZE(TR_CURRENT_CALIB))
#else
...
#if defined(COLORLCD)
#define TR_PHASES_HEADERS                                                     \
  {                                                                           \
    TR_PHASES_HEADERS_NAME, TR_PHASES_HEADERS_SW, TR_PHASES_HEADERS_RUD_TRIM, \
        TR_PHASES_HEADERS_ELE_TRIM, TR_PHASES_HEADERS_THT_TRIM,               \
        TR_PHASES_HEADERS_AIL_TRIM, TR_PHASES_HEADERS_CH5_TRIM,               \
        TR_PHASES_HEADERS_CH6_TRIM, TR_PHASES_HEADERS_FAD_IN,                 \
        TR_PHASES_HEADERS_FAD_OUT                                             \
  }
#elif defined(PCBTARANIS) || defined(PCBI8)
#define TR_PHASES_HEADERS                                                   \
  {                                                                         \
    HINT(TR_PHASES_HEADERS_NAME), HINT(TR_PHASES_HEADERS_SW),               \
        HINT(TR_PHASES_HEADERS_RUD_TRIM), HINT(TR_PHASES_HEADERS_ELE_TRIM), \
        HINT(TR_PHASES_HEADERS_THT_TRIM), HINT(TR_PHASES_HEADERS_AIL_TRIM), \
        HINT(TR_PHASES_HEADERS_FAD_IN), HINT(TR_PHASES_HEADERS_FAD_OUT)     \
  }
#endif

#define TR_LIMITS_HEADERS                                                      \
  {                                                                            \
    HINT(TR_LIMITS_HEADERS_NAME), HINT(TR_LIMITS_HEADERS_SUBTRIM),             \
        HINT(TR_LIMITS_HEADERS_MIN), HINT(TR_LIMITS_HEADERS_MAX),              \
        HINT(TR_LIMITS_HEADERS_DIRECTION), HINT(TR_LIMITS_HEADERS_CURVE),      \
        HINT(TR_LIMITS_HEADERS_PPMCENTER), HINT(TR_LIMITS_HEADERS_SUBTRIMMODE) \
  }
#define TR_LSW_HEADERS                                             \
  {                                                                \
    HINT(TR_LSW_HEADERS_FUNCTION), HINT(TR_LSW_HEADERS_V1),        \
        HINT(TR_LSW_HEADERS_V2), HINT(TR_LSW_HEADERS_V2),          \
        HINT(TR_LSW_HEADERS_ANDSW), HINT(TR_LSW_HEADERS_DURATION), \
        HINT(TR_LSW_HEADERS_DELAY)                                 \
  }
#define TR_GVAR_HEADERS                                       \
  {                                                           \
    HINT(TR_GVAR_HEADERS_FM0), HINT(TR_GVAR_HEADERS_FM1),     \
        HINT(TR_GVAR_HEADERS_FM2), HINT(TR_GVAR_HEADERS_FM3), \
        HINT(TR_GVAR_HEADERS_FM4), HINT(TR_GVAR_HEADERS_FM5), \
        HINT(TR_GVAR_HEADERS_FM6), HINT(TR_GVAR_HEADERS_FM7), \
        HINT(TR_GVAR_HEADERS_FM8)                             \
  }
